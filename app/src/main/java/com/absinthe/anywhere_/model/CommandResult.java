...
public class CommandResult {
    public static final String RESULT_NULL = "1000";
    public static final String RESULT_SUCCESS = "1001";
    ...
    public static final String RESULT_SECURITY_EXCEPTION = "1006";
    public static final String RESULT_URL_SCHEME = "1007";
