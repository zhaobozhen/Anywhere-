...
class CoordinatorWindowManager(private val context: Context, private val binder: ICollectorService) {
    ...
    fun addView() {
        if (!hasAdded) {
            ...
            view.confirmView.setOnClickListener {
                binder.stopCoordinator((view.targetView.x + view.targetView.measuredWidth / 2).toInt(),
