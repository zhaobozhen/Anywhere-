                ...
                override fun onLaunched() {
                    val a11yEntity = A11yEntity().apply {
                        ...
                        actions = listOf(
                                ...
                                A11yActionBean(A11yType.TEXT, content = "收付款|Money", activityId = "", delay = 0L),
                        )
                    }
                ...
                override fun onLaunched() {
                    val a11yEntity = A11yEntity().apply {
                        ...
                        actions = listOf(
                                A11yActionBean(A11yType.TEXT, content = "我|Me", activityId = "", delay = 300L),
                                A11yActionBean(A11yType.TEXT, content = "支付|WeChat Pay", activityId = "", delay = 800L),
                                A11yActionBean(A11yType.TEXT, content = "收付款|Money", activityId = "", delay = 800L),
                                A11yActionBean(A11yType.TEXT, content = "二维码收款|Receive Money", activityId = "", delay = 0L, actionActivity = "com.tencent.mm.plugin.offline.ui.WalletOfflineCoinPurseUI"),
                        )
                    }
                    val entity = AnywhereEntity.Builder().apply {
                        type = AnywhereType.Card.ACCESSIBILITY
