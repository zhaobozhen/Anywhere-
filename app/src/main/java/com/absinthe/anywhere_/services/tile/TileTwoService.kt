...
class TileTwoService : TileService() {
    ...
    override fun onStartListening() {
        ...
        qsTile?.let {
            ...
            it.state = if (GlobalValues.tileTwoActive) Tile.STATE_ACTIVE else Tile.STATE_INACTIVE
    ...
    override fun onClick() {
        val id = SPUtils.getString(this, Const.PREF_TILE_TWO)
        val intent = Intent(this, ShortcutsActivity::class.java).apply {
            ...
            putExtra(Const.INTENT_EXTRA_FROM_TILE, Const.PREF_TILE_TWO)
        }
